...
const HomeScreenMapCard = () => {
    ...
    useEffect(() => {
        ...
        const geojsonLayer = L.geoJSON(gz_2010_us_outline_500k).addTo(map);
    ...
    return(
            <div className="max-w-md rounded border-2 border-primary-GeoBlue overflow-hidden shadow-lg bg-white m-4">
